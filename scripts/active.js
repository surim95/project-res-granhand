...
gnbText.forEach((gnbTextAdd) => {
  ...
  window.addEventListener("scroll", () => {
    ...
    if (window.scrollY > 990) {
      ...
      iconImg.forEach((iconImgInvert) => {
        iconImgInvert.style.filter = "brightness(1)";
      });
    ...
    if (window.scrollY > 1874 && window.scrollY < 2874) {
      header.style.display = "none";
    } else if (window.scrollY < 1874 || window.scrollY > 2874) {
